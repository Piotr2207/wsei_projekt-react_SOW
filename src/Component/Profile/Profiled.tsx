...
function UserContent() {
  ...
  const editBtnHandler = (event: Event) => {
    console.log(event);
  };
  return (
    <UserContentContainer>
      <TopNav>
        <div>
          <Ic iconName="email.svg" /> <span>MESSAGE</span>
        </div>
        <div>
          <Ic iconName="document.svg" />
          <span>REATE A REQUESTC</span>
        </div>
        <div>
          <Ic iconName="add (1).svg" />
      ...
      <UserInfo>
        <PenBox onClick={(ev: any) => editBtnHandler(ev)}>
          <Ic iconName="pen.svg" />
        </PenBox>
        <PhotoBox>
          <UserPhoto>
      ...
      <PanelInformation>
        ...
        <div>
          [PHOTO] <b>First Name </b> <b>Last Name </b>
